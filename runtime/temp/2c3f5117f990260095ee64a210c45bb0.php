...
<div class="dialog-content">
    <form class="form-horizontal dialog-form" id="form">
        <div class="row">
            <div class="col-md-9">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="number" class="form-control form-control-sm" id="sort" name="sort">
                    </div>
                </div>
        ...
        <div class="td-align dialog-footer">
            ...
            <button class="btn btn-primary addkeys" type="button" data-url="<?php echo url('/v1/keys/keywords/add'); ?>"><i class="fa fa-save"></i> 确定提交</button>
        </div>
    </form>
</div>
