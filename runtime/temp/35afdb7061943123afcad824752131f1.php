            ...
            <div class="col-md-9">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <input type="hidden" name="pic_curr2" id="pic_curr2" value="<?php echo $data['pic2']; ?>">
                    </div>
                </div>
