...
<div class="dialog-content">
    <form class="form-horizontal dialog-form" id="form">
        <div class="row">
            <div class="col-md-9">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <script id="content" name="content" type="text/plain"><?php echo (isset($list['content']) && ($list['content'] !== '')?$list['content']:''); ?></script>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="td-align dialog-footer">
            ...
            <button class="btn btn-primary" type="button" onclick="editsolution(this)" data="<?php echo $list['id']; ?>" data-url="<?php echo url('/v1/work/works/editsolution'); ?>"><i class="fa fa-save"></i> 确定提交</button>
        </div>
    </form>
</div>
