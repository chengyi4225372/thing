<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:76:"/opt/web/hui-/public/../application/v1/view/systematic/cases/editdetail.html";i:1571713608;s:52:"/opt/web/hui-/application/v1/view/layout/dialog.html";i:1571369306;s:50:"/opt/web/hui-/application/v1/view/common/meta.html";i:1571642226;s:52:"/opt/web/hui-/application/v1/view/common/script.html";i:1571723378;}*/ ?>
<!DOCTYPE html>
        ...
        <div class="row">
            <div class="col-md-9">
                <div class="form-group">
                    <label for="pid" class="col-sm-3 control-label">父类：</label>
                    <div class="col-sm-9">
                        <select class="selectpicker show-tick form-control" title="全部" id="pid" name="pid"
                                data-actions-box="true" data-live-search="true">
                            <?php if(is_array($parent) || $parent instanceof \think\Collection || $parent instanceof \think\Paginator): $i = 0; $__LIST__ = $parent;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
                            <option value="<?php echo $key; ?>" <?php if($data['pid'] == $key): ?>selected = selected<?php endif; ?>><?php echo $list; ?></option>
