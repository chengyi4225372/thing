    ...
    <form class="form-horizontal dialog-form" id="form">
        <div class="row">
            <div class="col-md-9">
                ...
                <div class="form-group">
                    <label for="url" class="col-sm-3 control-label">跳转地址：</label>
                    <div class="col-sm-9">
                        <input type="text" id="iurl" class="form-control form-control-sm"  value="<?php echo $info['iurl']; ?>"/>
                    </div>
                </div>
        ...
        <div class="td-align dialog-footer">
            <button class="btn btn-primary editpartners" type="button"   data-url="<?php echo url('/v1/partners/partner/edit'); ?>"><i class="fa fa-save"></i> 确定提交</button>
