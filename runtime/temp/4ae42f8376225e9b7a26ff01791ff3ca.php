        ...
        <div class="row">
            <div class="col-md-9">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea class="form-control form-control-sm" name="content" id="content"><?php echo $info['content']; ?></textarea>
                    </div>
                </div>
