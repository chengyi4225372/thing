<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:72:"/opt/web/thing/public/../application/v1/view/customer/customers/add.html";i:1575877389;s:53:"/opt/web/thing/application/v1/view/layout/dialog.html";i:1575465348;s:51:"/opt/web/thing/application/v1/view/common/meta.html";i:1575463857;s:53:"/opt/web/thing/application/v1/view/common/script.html";i:1575463857;}*/ ?>
<!DOCTYPE html>
...
<div class="dialog-content">
    <form class="form-horizontal dialog-form" id="form">
        <div class="row">
            <div class="col-md-9">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <!--<input type="text" class="form-control form-control-sm" id="content" name="content" value=""/>-->
                        <textarea  id="contents" class="form-control form-control-sm"  rows="5"></textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="number" class="form-control form-control-sm" id="sort" placeholder="数字越大，排名越靠前...">
                    </div>
                </div>
        ...
        <div class="td-align dialog-footer">
            ...
            <button class="btn btn-primary" type="button" onclick="admin_module.add_hlg_customer(this)" data-url="<?php echo url('/v1/customer/customers/add'); ?>"><i class="fa fa-save"></i> 确定提交</button>
        </div>
    </form>
</div>
