...
<div class="dialog-content">
    <form class="form-horizontal dialog-form" id="form">
        ...
        <div class="td-align dialog-footer">
            ...
            <button class="btn btn-primary addsolution" type="button"  data-url="<?php echo url('/v1/work/works/addsolution'); ?>"><i class="fa fa-save"></i> 确定提交</button>
        </div>
    </form>
</div>
