<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:68:"/opt/web/thing/public/../application/v1/view/work/works/addcase.html";i:1575338835;s:53:"/opt/web/thing/application/v1/view/layout/dialog.html";i:1575277692;s:51:"/opt/web/thing/application/v1/view/common/meta.html";i:1573636141;s:53:"/opt/web/thing/application/v1/view/common/script.html";i:1573636141;}*/ ?>
<!DOCTYPE>
...
<div class="dialog-content">
    <form class="form-horizontal dialog-form" id="form">
        <div class="row">
            <div class="col-md-9">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea id="describe" class="form-control form-control-sm" cols="40" rows="5"></textarea>
                    </div>
                </div>
        ...
        <div class="td-align dialog-footer">
            ...
            <button class="btn btn-primary" type="button" onclick="addcases(this)" data-url="<?php echo url('/v1/work/works/addcase'); ?>"><i class="fa fa-save"></i> 确定提交</button>
        </div>
    </form>
</div>
