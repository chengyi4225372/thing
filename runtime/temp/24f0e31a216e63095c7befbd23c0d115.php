<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:74:"/opt/web/hui-/public/../application/v1/view/systematic/cases/editcase.html";i:1571814408;s:52:"/opt/web/hui-/application/v1/view/layout/dialog.html";i:1571369306;s:50:"/opt/web/hui-/application/v1/view/common/meta.html";i:1571642226;s:52:"/opt/web/hui-/application/v1/view/common/script.html";i:1571723378;}*/ ?>
<!DOCTYPE html>
        ...
        <div class="row">
            <div class="col-md-9">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control form-control-sm" id="is_show" name="is_show" value="<?php echo $data['is_show']; ?>" placeholder="样式名称将影响前台页面的布局，如有不明白的问PHP程序员">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control form-control-sm" id="title2" name="title2" value="<?php echo $data['title2']; ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="title3" class="col-sm-3 control-label">标题3：</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control form-control-sm" id="title3" name="title3" value="<?php echo $data['title3']; ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <input type="hidden" name="pic_curr" id="pic_curr" value="<?php echo $data['pic']; ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control form-control-sm" id="url" name="url" value="<?php echo $data['url']; ?>">
                    </div>
                </div>
