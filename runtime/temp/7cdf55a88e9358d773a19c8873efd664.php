...
<div class="dialog-content">
    <form class="form-horizontal dialog-form" id="form">
        <div class="row">
            <div class="col-md-9">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea  id="desc" class="form-control form-control-sm"  rows="5" value="<?php echo (isset($info['desc']) && ($info['desc'] !== '')?$info['desc']:''); ?>"></textarea>
                    </div>
                </div>
        ...
        <div class="td-align dialog-footer">
            ...
            <button class="btn btn-primary editworks" type="button"  data-url="<?php echo url('/v1/work/works/edit'); ?>"><i class="fa fa-save"></i> 确定提交</button>
        </div>
    </form>
</div>
