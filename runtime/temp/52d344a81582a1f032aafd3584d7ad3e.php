...
<div class="dialog-content">
    <form class="form-horizontal dialog-form" id="form">
            ...
            <div class="col-md-9">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <img id="imgs" src="<?php echo !empty($info['imgs'])?$info['imgs']:'/static/default.png'; ?>" style="width:150px;height:100px;">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="sort" class="form-control form-control-sm"  min="0" placeholder="数字越大，排名越靠前..." value="<?php echo $info['sort']; ?>"/>
                    </div>
                </div>
        ...
        <div class="td-align dialog-footer">
            ...
            <button class="btn btn-primary example_edit_add" type="button"  data-url="<?php echo url('/v1/cases/example/edit'); ?>"><i class="fa fa-save"></i> 确定提交</button>
        </div>
    </form>
</div>
