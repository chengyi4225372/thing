...
<div class="dialog-content">
    <form class="form-horizontal dialog-form" id="form">
        <div class="row">
            <div class="col-md-9">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="iurl" class="form-control form-control-sm" name="iurl" value=""/>
                    </div>
                </div>
        ...
        <div class="td-align dialog-footer">
            <button class="btn btn-primary addpartners" type="button"   data-url="<?php echo url('/v1/partners/partner/add'); ?>"><i class="fa fa-save"></i> 确定提交</button>
