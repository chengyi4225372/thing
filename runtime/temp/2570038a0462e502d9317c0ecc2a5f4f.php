...
<style>
    ...
    .dialog-footer{position:fixed;right:39%;top:95%}
    .red-color{color:red;}
</style>
<div class="dialog-content">
    <form class="form-horizontal dialog-form" id="form">
        <div class="row">
            <div class="col-md-9">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="file"  onchange="upload_files(this)" data-url="<?php echo url('/v1/cases/example/uploadimg'); ?>" style="display:none;" class="form-control form-control-sm" id="file">
                        <img id="imgs" src="/static/default.png" style="width:150px;height:100px;">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="sort" class="form-control form-control-sm"  min="0" placeholder="数字越大，排名越靠前..." value=""/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea  id="describes" class="form-control form-control-sm"  rows="5"></textarea>
                    </div>
                </div>
        ...
        <div class="td-align dialog-footer">
            ...
            <button class="btn btn-primary example_add" type="button"  data-url="<?php echo url('/v1/cases/example/add'); ?>"><i class="fa fa-save"></i> 确定提交</button>
        </div>
    </form>
</div>
