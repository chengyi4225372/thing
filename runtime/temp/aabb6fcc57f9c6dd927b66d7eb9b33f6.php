    ...
    <form class="form-horizontal dialog-form" id="form">
        <div class="row">
            <div class="col-md-9">
                ...
                <div class="form-group">
                    <label for="pic" class="col-sm-3 control-label">图片2：</label>
                    <div class="col-sm-9">
                        <button type="button" class="layui-btn" id="pic2" is_nginx="<?php echo $is_nginx; ?>">
                            <i class="layui-icon">&#xe67c;</i>上传图片
                        </button>
                        <img src="/static/default.png" style="width:50px;height:50px;" id="cur_pic2"/>
                        <input type="hidden" name="pic_curr2" id="pic_curr2" value="">
                    </div>
                </div>
                <div class="form-group">
